 ...
 * @param displacement 
 */
void EmitIndirectDisplacedRip(shellcode_t *code, uint8_t rx, uint32_t displacement) {
 ...
 * @param index 
 */
void EmitRexIndexed(shellcode_t *code,  Regs_x64 rx, Regs_x64 base, Regs_x64 index) {
